...
### Main
def main(linkDict):
    outPath = f"{os.getcwd()}/Paragon_Backend/Data/Scraping/data/videos/"
    ...
    for platform, links in linkDict.items():
        if platform == 'tiktok':
            for url in links:
                ...
                with open(f'{os.getcwd()}/Paragon_Backend/Data/Scraping/data/videos/tiktok/{fileName}.json', 'w', encoding='utf-8') as f:
            ...
            for url in links:
                ...
                with open(f'{os.getcwd()}/Paragon_Backend/Data/Scraping/data/videos/instagram/{fileName}.json', 'w', encoding='utf-8') as f:
                    json.dump(data, f, ensure_ascii=False, indent=4)
            ...
            for url in links:
                ...
                with open(f'{os.getcwd()}/Paragon_Backend/Data/Scraping/data/videos/youtube/{fileName}.json', 'w', encoding='utf-8') as f:
                    json.dump(data, f, ensure_ascii=False, indent=4)
...
if __name__ == '__main__':
    with open(f"{os.getcwd()}/Paragon_Backend/Data/Scraping/data/videoURLs.txt") as f: 
